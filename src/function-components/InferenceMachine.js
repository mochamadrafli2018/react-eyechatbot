...
const InferenceMachine = () => {
  ...
  function Output(input) {
    ...
    let question1 = `${question} ${sympthom[0][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question2 = `${question} ${sympthom[1][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question3 = `${question} ${sympthom[2][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question4 = `${question} ${sympthom[3][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question5 = `${question} ${sympthom[4][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question6 = `${question} ${sympthom[5][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question7 = `${question} ${sympthom[6][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question8 = `${question} ${sympthom[7][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question9 = `${question} ${sympthom[8][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question10 = `${question} ${sympthom[9][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question11 = `${question} ${sympthom[10][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question12 = `${question} ${sympthom[11][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question13 = `${question} ${sympthom[12][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question14 = `${question} ${sympthom[13][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question15 = `${question} ${sympthom[14][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question16 = `${question} ${sympthom[15][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question17 = `${question} ${sympthom[16][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question18 = `${question} ${sympthom[17][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question19 = `${question} ${sympthom[18][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question20 = `${question} ${sympthom[19][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question21 = `${question} ${sympthom[20][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question22 = `${question} ${sympthom[21][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question23 = `${question} ${sympthom[22][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question24 = `${question} ${sympthom[23][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question25 = `${question} ${sympthom[24][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question26 = `${question} ${sympthom[25][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question27 = `${question} ${sympthom[26][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question28 = `${question} ${sympthom[27][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question29 = `${question} ${sympthom[28][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question30 = `${question} ${sympthom[29][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question31 = `${question} ${sympthom[30][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    //let question32 = `${question} ${sympthom[31][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question33 = `${question} ${sympthom[32][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question34 = `${question} ${sympthom[33][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question35 = `${question} ${sympthom[34][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question36 = `${question} ${sympthom[35][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question37 = `${question} ${sympthom[36][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question38 = `${question} ${sympthom[37][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question39 = `${question} ${sympthom[38][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question40 = `${question} ${sympthom[39][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question41 = `${question} ${sympthom[40][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    //let question42 = `${question} ${sympthom[41][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question43 = `${question} ${sympthom[42][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question44 = `${question} ${sympthom[43][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question45 = `${question} ${sympthom[44][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question46 = `${question} ${sympthom[45][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question47 = `${question} ${sympthom[46][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question48 = `${question} ${sympthom[47][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question49 = `${question} ${sympthom[48][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question50 = `${question} ${sympthom[49][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question51 = `${question} ${sympthom[50][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question52 = `${question} ${sympthom[51][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question53 = `${question} ${sympthom[52][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
    let question54 = `${question} ${sympthom[53][0]} pada mata anda ? <span class='ya-tidak'>y/t</span>`;
